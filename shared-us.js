...
//   ⚪ 弱映射 — 内需/政策驱动为主
//
// 🛡️ 新增标的验证规则（每次添加前必须完成）：
//   ① 数据验证：搜近30天，至少3次"美股事件→A股次日跟"的案例
//   ② 传导路径确认：供应链绑定/估值锚/情绪题材（三选一）
//   ③ 偏离警告：什么情况下该降级或移除
//
// 新增标的验证日志：
// ┌──────────────────────────────────────────────────────────────┐
// │ 标的: 信维通信 → SPCX   日期: 2026-06-12                   │
// │ 证据: 5/18 IPO预热→卫星ETF+3%                             │
// │       5/23 星舰发射→新雷能+13%/火炬电子+8%                │
// │       5/27 FAA停飞→板块调整                               │
// │       6/9 IPO认购4倍→融资客抢筹                           │
// │       6/12 上市当天→全天候关注                            │
// │ 路径: 估值锚+供应链  级别: 🔗中                           │
// │ 偏离: SPCX持续亏损超预期→降弱映射                        │
// ├──────────────────────────────────────────────────────────────┤
// │ 标的: 紫金矿业/山东黄金 → GDX  日期: 2026-06-12           │
// │ 证据: 铜/金/铝全球统一定价，联动系数~0.35-0.45            │
// │       美联储利率决议→美元指数→金价→山东黄金 链条清晰     │
// │       2026年5月铜价波动→江西铜业/紫金同步±2-4%           │
// │ 路径: 全球定价锚  级别: 🔗中                              │
// │ 偏离: 国内供给侧改革超预期→减弱映射                       │
// ├──────────────────────────────────────────────────────────────┤
// │ 标的: 中国卫通/中国卫星 → SPCX  日期: 2026-06-12          │
// │ 证据: SpaceX上市确立1.75万亿估值锚，国常会商业航天入十五五│
// │       券商研报:"SpaceX上市为板块提供全球估值锚"          │
// │       但非供应链直接绑定，更多情绪+估值重塑传导           │
// │ 路径: 估值锚  级别: 🔗弱                                  │
// │ 偏离: SPCX跌破万亿估值→移除映射                          │
// └──────────────────────────────────────────────────────────────┘
//
